...
type PassportPlatformALoginPostRequest struct {
	EncryptedSessionKey string `thrift:"encrypted_session_key,1,required" form:"encrypted_session_key,required" json:"encrypted_session_key,required" query:"encrypted_session_key,required"`
}

func NewPassportPlatformALoginPostRequest() *PassportPlatformALoginPostRequest {
	return &PassportPlatformALoginPostRequest{}
}

func (p *PassportPlatformALoginPostRequest) InitDefault() {
}

func (p *PassportPlatformALoginPostRequest) GetEncryptedSessionKey() (v string) {
	return p.EncryptedSessionKey
}

var fieldIDToName_PassportPlatformALoginPostRequest = map[int16]string{
	1: "encrypted_session_key",
}

func (p *PassportPlatformALoginPostRequest) Read(iprot thrift.TProtocol) (err error) {
	var fieldTypeId thrift.TType
	var fieldId int16
	var issetEncryptedSessionKey bool = false
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_PassportPlatformALoginPostRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_PassportPlatformALoginPostRequest[fieldId]))
}

func (p *PassportPlatformALoginPostRequest) ReadField1(iprot thrift.TProtocol) error {
	...
	p.EncryptedSessionKey = _field
	return nil
}

func (p *PassportPlatformALoginPostRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassportPlatformALoginPostRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *PassportPlatformALoginPostRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("encrypted_session_key", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.EncryptedSessionKey); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *PassportPlatformALoginPostRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PassportPlatformALoginPostRequest(%+v)", *p)

}

type PassportPlatformALoginPostResponse struct {
	Data *User  `thrift:"data,1,required" form:"data,required" json:"data,required" query:"data,required"`
	Code int32  `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg  string `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
}

func NewPassportPlatformALoginPostResponse() *PassportPlatformALoginPostResponse {
	return &PassportPlatformALoginPostResponse{}
}

func (p *PassportPlatformALoginPostResponse) InitDefault() {
}

var PassportPlatformALoginPostResponse_Data_DEFAULT *User

func (p *PassportPlatformALoginPostResponse) GetData() (v *User) {
	if !p.IsSetData() {
		return PassportPlatformALoginPostResponse_Data_DEFAULT
	}
	return p.Data
}

func (p *PassportPlatformALoginPostResponse) GetCode() (v int32) {
	return p.Code
}

func (p *PassportPlatformALoginPostResponse) GetMsg() (v string) {
	return p.Msg
}

var fieldIDToName_PassportPlatformALoginPostResponse = map[int16]string{
	1:   "data",
	253: "code",
	254: "msg",
}

func (p *PassportPlatformALoginPostResponse) IsSetData() bool {
	return p.Data != nil
}

func (p *PassportPlatformALoginPostResponse) Read(iprot thrift.TProtocol) (err error) {
	var fieldTypeId thrift.TType
	var fieldId int16
	var issetData bool = false
	var issetCode bool = false
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_PassportPlatformALoginPostResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_PassportPlatformALoginPostResponse[fieldId]))
}

func (p *PassportPlatformALoginPostResponse) ReadField1(iprot thrift.TProtocol) error {
	_field := NewUser()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *PassportPlatformALoginPostResponse) ReadField253(iprot thrift.TProtocol) error {
...
func (p *PassportPlatformALoginPostResponse) ReadField254(iprot thrift.TProtocol) error {
...
func (p *PassportPlatformALoginPostResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("PassportPlatformALoginPostResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *PassportPlatformALoginPostResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("data", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Data.Write(oprot); err != nil {
...
func (p *PassportPlatformALoginPostResponse) writeField253(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("code", thrift.I32, 253); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.Code); err != nil {
...
func (p *PassportPlatformALoginPostResponse) writeField254(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("msg", thrift.STRING, 254); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Msg); err != nil {
...
func (p *PassportPlatformALoginPostResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("PassportPlatformALoginPostResponse(%+v)", *p)
